...
RULE_INT(Spells, PetBuffProcValueScale, 100, "Percent scale applied to direct damage and healing from pet owner/self-buff melee procs and poison procs. Weapon and augment procs are not affected. 100 = normal, 40 = 40% value.")
