...
RULE_REAL(AoT, MaxHitOffenseMultiplier,     0.0085,  "Determines how much player's offense is a factor in maximum melee hits. Vanilla is ~ 0.01.")
...
RULE_REAL(AoT, AccuracyPerDex,     			1.0,  "Accuracy per dexterity point")
RULE_REAL(AoT, AvoidancePerAgi,     		0.4,  "Avoidance per agility point")
RULE_REAL(AoT, PotencyPerInt,     			0.5,  "How much does intellect boost potency")
...
RULE_REAL(AoT, ResistCapPerHWis,     		2.5,  "How much does heroic wisdom boost global resist cap")
RULE_REAL(AoT, ResistPerHResist,     		2.0,  "How valuable is heroic resist")
RULE_REAL(AoT, ResistCapPerHResist,     	5.0,  "How much does heroic resist boost resist cap")
RULE_INT(AoT, ResisteHPHardCap,     		300,  "eHP hardcap of 300 is 75% damage reduction.")
RULE_REAL(AoT, DCPerCha, 					1.0,	"Difficulty Class gained per point of Charisma.")
RULE_REAL(AoT, DCPerHCha, 					2.0,	"Difficulty Class gained per point of Heroic Charisma.")
RULE_INT(AoT, DCOverpowerCap, 				100,	"Maximum DC overflow (DC - Resist) that can contribute to bonus spell damage.")
RULE_REAL(AoT, DCOverpowerMultPerHCha, 		0.005,	"Bonus overflow damage multiplier gained per point of Heroic Charisma before the soft cap.")
RULE_REAL(AoT, DCOverpowerMultAfterCapReturns, 0.5,	"Multiplier applied to Heroic Charisma scaling after the overflow multiplier soft cap.")
RULE_INT(AoT, DCOverpowerMultSoftCap, 		100,	"Heroic Charisma soft cap for overflow damage multiplier scaling.")
RULE_INT(AoT, DCOverpowerMultHardCap, 		400,	"Maximum Heroic Charisma considered when calculating overflow damage multiplier.")
