...
public:
	...
	Lua_Expedition  CreateXPDZ(std::string zone_name, uint32 version, std::string dz_name, uint32 min_players, uint32 max_players);
	Lua_Expedition  CreateRaidDZ(std::string zone_name, uint32 version, std::string dz_name, uint32 min_players, uint32 max_players);
