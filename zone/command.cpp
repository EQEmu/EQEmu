...
int command_init(void)
{
	...
	if (
		...
		command_add("dzadd", "<player_name> - Invite a player to your expedition or dynamic zone (leader only)", AccountStatus::Player, command_dzadd) ||
		...
		command_add("dzleader", "<player_name> - Transfer expedition leadership to another member (leader only)", AccountStatus::Player, command_dzleader) ||
		command_add("dzquit", "Leave your current expedition or dynamic zone", AccountStatus::Player, command_dzquit) ||
