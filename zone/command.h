...
void command_dzleader(Client *c, const Seperator *sep);
void command_dzquit(Client *c, const Seperator *sep);
...
void command_refreshpet(Client *c, const Seperator *sep);
